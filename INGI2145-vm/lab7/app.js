...
mongo.connect('mongodb://localhost:27017/lab7', function(err, db) {
    ...
    //Setting index as a compound field comprised of both the country and first_name
    //Note: 'index':1 implies that the records are sorted ascendingly
    //The converse is true for 'index':-1
    //TODO Exercise-II: For the second exercise, you'll be required to modfiy this as you see fit
